...
import { PlotType, SqftUnit, BookMySqftPlotInfo } from '../../types';
...
const Dashboard: React.FC = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto py-10 px-4">
      ...
      {/* Plot Marketplace Section */}
      <div className="bg-white rounded-lg shadow p-6 border border-green-100 mb-8">
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-xl font-semibold text-green-600">Plot Marketplace</h2>
          <button
      ...
      {/* BookMySqft Plots Section */}
      <div className="bg-white rounded-lg shadow p-6 border border-green-100 mb-8">
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-xl font-semibold text-green-600">BookMySqft Plots</h2>
          <button
