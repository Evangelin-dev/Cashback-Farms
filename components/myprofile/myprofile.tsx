  ...
  return (
    <>
      <div className="max-w-4xl mx-auto mt-8 p-0 flex gap-8">
          ...
          <form className="space-y-5 animate-slidein" onSubmit={e => { e.preventDefault(); handleSave(); }}>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <label className="inline-flex items-center px-4 py-2 bg-gradient-to-r from-green-400 to-green-600 text-white rounded-lg shadow cursor-pointer hover:from-green-500 hover:to-green-700 transition font-semibold text-sm gap-2">
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M12 4v16m8-8H4" />
                  </svg>
                  {editProfile.aadharFileName ? "Change File" : "Choose File"}
                  <input
                    type="file"
                ...
                {editProfile.aadharFileName && (
                  <span className="text-xs text-gray-700 ml-2">{editProfile.aadharFileName}</span>
                )}
              </div>
              <div>
                <label className="block text-xs text-gray-500 mb-1">PAN Upload</label>
                <label className="inline-flex items-center px-4 py-2 bg-gradient-to-r from-blue-400 to-blue-600 text-white rounded-lg shadow cursor-pointer hover:from-blue-500 hover:to-blue-700 transition font-semibold text-sm gap-2">
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M12 4v16m8-8H4" />
                  </svg>
                  {editProfile.panFileName ? "Change File" : "Choose File"}
                  <input
                    type="file"
                    accept=".pdf,.jpg,.jpeg,.png"
                    className="hidden"
                ...
                {editProfile.panFileName && (
                  <span className="text-xs text-gray-700 ml-2">{editProfile.panFileName}</span>
                )}
              </div>
            </div>
          ...
          {showPopup && (
            <div className="fixed inset-0 flex items-center justify-center z-50 bg-black bg-opacity-30">
              <div className="bg-white rounded-lg shadow-lg px-8 py-6 flex flex-col items-center animate-fadein">
                <div className="w-12 h-12 text-green-500 mb-2 animate-bounce text-4xl">✓</div>
                <div className="text-lg font-semibold text-green-700 mb-1">Profile changes saved!</div>
              </div>
            </div>
          )}
          <style>{`
        ...
        {/* Right: Bank Details Module & Recent Purchases */}
        <div className="w-[28rem] flex-shrink-0">
          {/* --- Bank Details Module Card --- */}
          <div className="bg-white rounded-2xl shadow-xl p-6 mb-6">
            <h3 className="text-lg font-bold text-primary-light mb-3 animate-fadein">Bank Details Module</h3>
            <div className="space-y-3">
              ...
              <div className="flex gap-2 mt-6">
                ...
                <button
                  type="button"
                  className="bg-gray-200 text-gray-700 px-6 py-2 rounded text-base font-semibold shadow hover:scale-105 transition-transform duration-200"
                  // onClick={handleCancelBankDetails} // Implement handler if needed
                >
                  Cancel
                </button>
              </div>
              {/* Creative popup for bank details */}
              {showPopup && (
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40">
                  <div className="relative bg-gradient-to-br from-green-100 via-white to-green-200 rounded-2xl shadow-2xl px-10 py-8 flex flex-col items-center animate-bankpop">
                    ...
                    <div className="text-2xl font-bold text-green-700 mb-2 text-center">Bank Details Saved!</div>
                    <div className="text-base text-gray-700 mb-4 text-center">
                      Your bank details have been submitted.<br />
                      <span className="font-semibold text-green-600">Admin approval is required.</span>
                    </div>
                    <button
                      className="mt-2 px-6 py-2 bg-primary text-white rounded-lg font-semibold shadow hover:bg-green-700 transition"
                      onClick={() => setShowPopup(false)}
                    >
                      OK
                    </button>
                  ...
                  <style>{`
                    ...
                    .animate-bankpop { animation: bankpop 0.6s cubic-bezier(.68,-0.55,.27,1.55); }
          ...
          <div className="bg-white rounded-2xl shadow-xl p-6 mb-6">
            <h3 className="text-lg font-bold text-primary-light mb-3 animate-fadein">Referral & Commission System</h3>
            <div className="space-y-2 text-gray-700 text-sm">
              <div>• Users get a unique referral code.</div>
            ...
            <button
              className="mt-6 px-6 py-2 bg-primary text-white rounded-lg font-semibold shadow hover:bg-green-700 transition"
      ...
      <div className="mt-10 w-full bg-gradient-to-br from-green-50 via-white to-green-100 rounded-2xl shadow-2xl border border-green-200 p-8 flex flex-col items-center animate-fadein">
        <h2 className="text-2xl font-extrabold text-green-700 mb-4 tracking-tight flex items-center gap-2">
          <svg className="w-7 h-7 text-green-500 animate-pulse" fill="none" stroke="currentColor" strokeWidth={2.5} viewBox="0 0 24 24">
        ...
        <div className="w-full flex flex-col md:flex-row gap-8 mb-6">
          {/* Total Earnings Card */}
          <div className="flex-1 bg-white rounded-xl shadow-lg p-6 flex flex-col items-center border border-green-100 animate-fadein-up">
            ...
            <span className="text-sm text-gray-600">All levels combined</span>
          </div>
          {/* Commission Breakup Card */}
          <div className="flex-1 bg-white rounded-xl shadow-lg p-6 flex flex-col items-center border border-green-100">
            ...
            <div className="w-full flex flex-col gap-2">
              <div className="flex items-center justify-between">
                ...
                <span className="font-bold text-green-700">₹9,000</span>
              </div>
              <div className="flex items-center justify-between">
          ...
          <div className="flex-1 bg-white rounded-xl shadow-lg p-6 flex flex-col items-center border border-green-100">
            ...
            <div className="w-full flex flex-col gap-2">
              <div className="flex items-center justify-between">
                <span className="text-gray-700">#REQ1234</span>
                <span className="text-yellow-600 font-semibold animate-pulse">Pending</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-gray-700">#REQ1222</span>
                <span className="text-green-600 font-semibold">Paid</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-gray-700">#REQ1201</span>
                <span className="text-red-600 font-semibold">Rejected</span>
              </div>
            </div>
            <button className="mt-4 px-5 py-2 bg-primary text-white rounded-lg font-semibold shadow hover:bg-green-700 transition animate-bounce">
              Request Withdrawal
            </button>
          </div>
        </div>
        ...
        <div className="w-full mt-6">
          <h4 className="text-lg font-bold text-green-700 mb-2">Payment Status Timeline</h4>
          <div className="flex flex-col md:flex-row gap-4 items-center justify-center">
            <div className="flex flex-col items-center">
              <div className="w-10 h-10 rounded-full bg-green-500 flex items-center justify-center text-white text-xl font-bold shadow-lg animate-bounce">
                <svg className="w-6 h-6" fill="none" stroke="currentColor" strokeWidth={2.5} viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" />
                </svg>
              </div>
              <span className="mt-2 text-xs text-green-700 font-semibold">Requested</span>
            </div>
            <div className="w-8 h-1 bg-green-200 rounded-full mx-2 md:mx-4"></div>
            <div className="flex flex-col items-center">
              <div className="w-10 h-10 rounded-full bg-yellow-400 flex items-center justify-center text-white text-xl font-bold shadow-lg animate-pulse">
                <svg className="w-6 h-6" fill="none" stroke="currentColor" strokeWidth={2.5} viewBox="0 0 24 24">
                  <circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4"></circle>
                  <path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8v8z"></path>
                </svg>
              </div>
              <span className="mt-2 text-xs text-yellow-700 font-semibold">Processing</span>
            </div>
            <div className="w-8 h-1 bg-green-200 rounded-full mx-2 md:mx-4"></div>
            <div className="flex flex-col items-center">
              <div className="w-10 h-10 rounded-full bg-green-700 flex items-center justify-center text-white text-xl font-bold shadow-lg animate-bounce">
                <svg className="w-6 h-6" fill="none" stroke="currentColor" strokeWidth={2.5} viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" />
                </svg>
              </div>
              <span className="mt-2 text-xs text-green-800 font-semibold">Paid</span>
            </div>
          </div>
        </div>
        <style>{`
