...
const SyndicatePlot: FC = () => {
  ...
  // Dummy plot details (could be fetched from API)
  const plotDetails = {
    facing: 'north',
              ...
              <div>
                ...
                <div className="space-y-1 max-h-40 overflow-y-auto">
                  <div className="text-xs text-gray-600 mb-2">
                    <div><strong>Facing:</strong> {plotDetails.facing}</div>
                    <div><strong>Survey #:</strong> {plotDetails.survey_number}</div>
                    <div><strong>Plot Type:</strong> {plotDetails.plot_type}</div>
                    <div><strong>Total Area:</strong> {plotDetails.total_area.toLocaleString('en-IN')} {plotDetails.area_unit}</div>
                    <div><strong>Price per Unit:</strong> ₹{plotDetails.price_per_unit.toLocaleString('en-IN')}</div>
                  </div>
