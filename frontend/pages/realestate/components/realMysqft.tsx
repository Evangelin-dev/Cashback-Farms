...
const RealMySqft: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      >
        {/* Header with title and Create Project button */}
        <Box
          sx={{
            display: 'flex',
        ...
        >
          ...
          >
             Micro Plots <span style={{ fontWeight: 400, fontSize: 14, color: '#166534' }}>Property Management</span>
          </Typography>
          {/* Move Create Project button here */}
