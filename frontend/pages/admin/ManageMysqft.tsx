...
const ManageMysqft: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      >
       Admin - MySqft <span style={{ fontWeight: 400, fontSize: 18, color: '#166534' }}>Property Management</span>
      </Typography>
      <Box
        sx={{
                ...
                <Stack spacing={1.5}>
                  ...
                  {entry.project.projectMap && (
                    <Typography variant="body2" sx={{ mt: 1 }}>
                      <b>Map File:</b> {entry.project.projectMap.name}
                    </Typography>
                  )}
                </Stack>
              </CardContent>
              ...
              <CardContent sx={{ background: '#f6fff8', borderRadius: 2 }}>
                <Stack spacing={1.5}>
                  ...
                  {projectData.projectMap && (
                    <Typography variant="body2" sx={{ mt: 1 }}>
                      <b>Map File:</b> {projectData.projectMap.name}
                    </Typography>
                  )}
                </Stack>
              </CardContent>
