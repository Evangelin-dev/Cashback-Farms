...
const DSqftGrid: React.FC<SqftGridProps> = ({
  ...
  return (
    <div className="flex flex-col items-center w-full min-h-screen px-4 py-6 gap-4 sm:gap-6 lg:gap-8">
      ...
      {/* Two-row layout: Row 1 -> image (left) + grid (right); Row 2 -> selected plots (full width) */}
      <div className="flex flex-col w-full max-w-7xl gap-6 lg:gap-8">
        {/* Row 1: Image (left) and Grid (right) */}
        <div className="flex flex-col lg:flex-row w-full gap-6 items-start">
          {/* Left: Plot layout image with controls */}
          <div className="w-full lg:w-1/2 flex-shrink-0 flex flex-col items-center">
            <div
              ref={imgFrameRef}
              className="flex-shrink-0 flex items-center justify-center bg-white rounded-xl shadow border border-green-100 overflow-hidden w-full"
              style={{
          ...
          <div className="flex-1 w-full lg:w-1/2">
            <div
              ...
              className="relative flex flex-col items-center justify-center rounded-3xl shadow-2xl border-0 bg-white/60 backdrop-blur-lg p-4 sm:p-6"
              style={{
                width: '100%',
  ...
  {/* Row 2: Selected plot details full width (below row 1) */}
        <div className="w-full">
          {selectedUnits.length > 0 && (
            <div className="bg-white/80 rounded-3xl shadow-2xl border border-green-100 w-full overflow-y-auto scrollbar-thin scrollbar-thumb-green-200 scrollbar-track-transparent p-4 flex flex-col gap-3 sm:gap-4">
              <h3 className="text-lg sm:text-xl font-extrabold text-green-700 mb-2 bg-white/90 backdrop-blur-md z-10 pb-2 rounded-t-2xl">
