...
const AuthModal: React.FC<AuthModalProps> = ({ isOpen, onClose, onAuthSuccess }) => {
  ...
  const handleVerifyOtp = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const { access, refresh, user } = login.data;
      ...
      const userForContext = {
        ...
        mobile: input,
        mobileVerified: true,
        role: user.user_type === 'real_estate_agent' ? 'ADMIN' : 'USER' // Adjust based on your UserRole enum
      };
  ...
  const handleGoogleLogin = () => {
    ...
    setTimeout(() => {
      ...
      const googleUser = {
        ...
        name: 'Google User',
        user_type: 'user',
        role: 'USER' // Adjust based on your UserRole enum
      };
